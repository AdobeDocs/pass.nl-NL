...
* Maakt en handhaaft besluiten over inhoudstoegang die op informatie wordt gebaseerd die door de Dienst van de Controle van de Valuta wordt verstrekt (dit is geldig in het [&#x200B; geval van het Punt van de Informatie van het Beleid 0&rbrace;)](/help/concurrency-monitoring/policy-info-pt-versionone.md)
