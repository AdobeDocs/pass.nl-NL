...
Om tot het product van de Rapporten van het Gebruik van de Controle van de Gelijktijdige toegang te hebben, moet een klant eerst het Gelijktijdige Controle [ Team van de Steun ](mailto:tve-support@adobe.com) contacteren en zij zullen de noodzakelijke stappen uitvoeren om u toegang tot het API product te verlenen. Meer details op [ CMU API Toegang ](/help/concurrency-monitoring/reports/cmu-api-access.md).
...
Voor beste gegevensnauwkeurigheid, adviseren wij de rapporten die op deze pagina [ worden voorgesteld CMU voorbeelden van rapporten ](/help/concurrency-monitoring/reports/cm-usage-reports-examples.md)
