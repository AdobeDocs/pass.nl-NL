...
Op dit tabblad wordt een lijst met aangepaste schema&#39;s weergegeven.
De aangepaste schema&#39;s kunnen worden gebruikt voor de Android- en iOS-apparaten.
...
1. Aangepast schema - Het aangepaste schema dat in het TVE-dashboard is gemaakt, kan worden gebruikt voor Android-apparaattoepassingen.

1. Voeg de volgende code toe in het bronbestand van uw toepassing `strings.xml` :
...
U kunt een aangepast schema gebruiken in het `info.plist` -bestand van uw toepassing. In het onderstaande voorbeeld moet u de URL toevoegen die is gegenereerd in het TVE-dashboard:
