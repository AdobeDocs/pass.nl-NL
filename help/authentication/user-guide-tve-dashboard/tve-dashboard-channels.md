...
![ Lijst van bestaande kanalen ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channels-list-view.png)
...
1. Selecteer een van de volgende tabbladen om de bijbehorende instellingen van het geselecteerde kanaal weer te geven en te bewerken:
   ...
   * [Aangepaste schema&#39;s](#custom-schemes)
   ...
   ![ montages van het Kanaal ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-tabs-view.png)
...
![ geef de informatie van het Kanaal uit ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-general-settings-tab-view.png)
...
![ laat de Configuraties van Analytics ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-analytics-configuration-button.png) toe
...
![ Lijst van Beschikbare Integraties ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-integrations-tab-view.png)
...
1. Selecteer **nieuw certificaat** bij de bovenkant van de **Beschikbare sectie van Certificaten** toevoegen.
   ...
   ![ voeg een nieuw certificaat toe ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-certificate-button.png)
...
1. Selecteer **verwijderen**.
   ...
   ![ verwijder het geselecteerde certificaat ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-delete-certificate-button.png)
...
![ Overgenomen beschikbare certificaten ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-inherited-available-certificates-panel-view.png)
...
1. Selecteer **nieuw domein** bij de hoger-juiste hoek van de **Beschikbare Domeinen** sectie toevoegen.
   ...
   ![ voeg een nieuw domein ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-domain-button.png) toe
...
1. Selecteer **verwijderen**.
   ...
   ![ verwijder het geselecteerde domein ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-remove-domain-button.png)
...
Op dit tabblad wordt een lijst met geregistreerde toepassingen weergegeven. Voor meer details met betrekking tot geregistreerd toepassingsgebruik, verwijs naar het [ dynamische overzicht van de cliëntregistratie ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-dcr/dynamic-client-registration-overview.md) documentatie.
...
1. Selecteer **nieuwe toepassing** bij de hoger-juiste hoek van de **Geregistreerde sectie van Toepassingen** toevoegen.
   ...
   ![ voeg een nieuwe toepassing ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-application-button.png) toe
...
1. Selecteer **Download**.
   ...
   ![ Download een softwareverklaring ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-download-software-statement-button.png)
...
1. Selecteer **produceer nieuwe douaneregeling**.
   ...
   ![ produceer een nieuw douaneregeling ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-custom-scheme-button.png)
...
![ Overerfde douaneregelingen ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-inherited-custom-schemes-panel-view.png)
...
1. Selecteer **nieuw kanaal** bij de hoger-juiste hoek van de **Kanalen** sectie toevoegen.
   ...
   ![ voeg een nieuw kanaal ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-channel-button.png) toe
