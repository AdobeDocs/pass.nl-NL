...
![ Lijst van bestaande programmeurs ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmers-list-view.png)
...
1. Selecteer een van de volgende tabbladen om de bijbehorende instellingen van de geselecteerde programmeur weer te geven en te bewerken:
   ...
   * [Aangepaste schema&#39;s](#custom-schemes)
   ...
   ![ montages van de Programmer ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-tabs-view.png)
...
![ voeg een nieuw kanaal ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-add-new-channel-button.png) toe
...
1. Selecteer **nieuw certificaat** bij de hoger-juiste hoek van de **Beschikbare sectie van Certificaten** toevoegen.
   ...
   ![ voeg een nieuw certificaat toe ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-add-new-certificate-button.png)
...
1. Selecteer **verwijderen**.
   ...
   ![ verwijder het geselecteerde certificaat ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-remove-certificate-button.png)
...
1. Selecteer **nieuwe toepassing** bij de hoger-juiste hoek van de **Geregistreerde sectie van Toepassingen** toevoegen.
   ...
   ![ voeg een nieuwe toepassing ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-add-new-application-button.png) toe
...
1. Selecteer **Download**.
   ...
   ![ Download een softwareverklaring ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-download-software-statement-button.png)
...
1. Selecteer **produceer nieuwe douaneregeling**.
   ...
   ![ produceer een nieuw douaneregeling ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-add-new-custom-scheme-button.png)
...
1. Selecteer **nieuwe programmeur** bij de hoger-juiste hoek van de **sectie van Programmers** toevoegen.
   ...
   ![ voeg een nieuwe programmeur ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/programmers/programmer-add-new-programmer-button.png) toe
...
Er is een nieuwe configuratiewijziging gemaakt en deze is gereed voor serverupdate. Om de nieuwe programmeur te gebruiken die in de **sectie wordt vermeld van 0} Programmers {, ga met de** overzicht te werk en druk veranderingen [ stroom.](/help/authentication/user-guide-tve-dashboard/tve-dashboard-review-push-changes.md)
