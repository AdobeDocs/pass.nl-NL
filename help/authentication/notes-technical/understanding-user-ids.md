...
| getMetadata(), eigenschap userID | Account link, fraude-onderzoek met MVPD | Nee | Nee | - Dit bezit staat Adobe toe om de daadwerkelijke bronMVPD Gebruiker - identiteitskaart aan de Programmeur bloot te stellen. </br> </br> - In de configuratie van de Adobe kan deze worden ingesteld als gecodeerd of niet (afhankelijk van de MVPD-voorkeur). Als het gecodeerd is, wordt het versleuteld met de openbare sleutel van het certificaat van de programmeur dat aan de Adobe wordt verstrekt, zodat het niet in duidelijke taal aan de client wordt getoond. </br> </br> - Dit geeft de programmeur de daadwerkelijke identiteitskaart van de Gebruiker van MVPD, zodat is het iets dat voor rekening het verbinden of fraudeonderzoek direct met MVPD kan worden gebruikt. |


**In conclusie**

* In het algemeen, verstrekt MVPD een blijvende unieke identiteitskaart <u> en gaat het tot Adobe over succesvolle authentificatie </u>. Het is over het algemeen verenigbaar over alle netwerken. De uitzondering is Comcast MVPD, die een verschillende Gebruiker - identiteitskaart voor elk kanaal verstrekt.
