...
1. Wat is de MVPD-verslaggeving van fireTV SSO?
   ...
   * **Alle MVPD&#39;s** geïntegreerd door Adobe Pass Authentication wordt technisch ondersteund op fireTV SDK.
...
1. Werkt andere functionaliteit voor Adoben zoals voorheen?
   ...
   * Alle Adobe Pass-verificatiefuncties werken op fireTV net als op Android-apparaten.
