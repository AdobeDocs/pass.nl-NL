...
De authentificatiesessie kan op de [&#x200B; toepassing van de 0&rbrace; Programmer &lbrace;ook wijzen om met het &#x200B;](#programmer) toestemmings [&#x200B; proces als volgende fase van de &#x200B;](#authorization) recht [&#x200B; stroom te werk te gaan voor het geval de gebruiker reeds voor authentiek verklaard wordt.](#entitlement)
...
Het besluit is een concept van de Authentificatie van Adobe Pass dat informatie over de [&#x200B; &#x200B;](#mvpd) vergunning [&#x200B; of &#x200B;](#authorization) prepermission [&#x200B; procesonderzoek opslaat om gebruikerstoegang tot a &#x200B;](#preauthorization) te verlenen of te ontkennen programmeur [&#x200B; beschermde inhoud.](#programmer)
...
Voor meer informatie, verwijs naar de [&#x200B; documentatie van de Eigenschap van 0&rbrace; Afbraak.](/help/premium-workflow/degraded-access/degradation-feature.md)

#### Apparaat-id {#device-id}

Apparaatidentiteitskaart is een uniek herkenningsteken gebonden aan het apparaat van de gebruiker en moet door de [&#x200B; 1&rbrace; toepassing van de Programmer &lbrace;op alle fasen van de &#x200B;](#programmer) betitelings [&#x200B; stroom worden verstrekt.](#entitlement)
...
De MVPD wordt geïdentificeerd door een unieke waarde die tijdens het instapproces tussen de MVPD en Adobe is gedefinieerd.
...
De partner wordt geïdentificeerd door een unieke waarde (bijvoorbeeld &quot;appel&quot;) die tijdens het instapproces tussen de partner en Adobe wordt bepaald.
...
De dienstverlener wordt geïdentificeerd door een unieke waarde die tijdens het aan boord nemen proces tussen Programmer en Adobe wordt bepaald.
...
Enige sign-on (SSO) is een proces dat een gebruiker toestaat om eens voor authentiek te verklaren en toegang te krijgen tot veelvoudige [&#x200B; toepassingen van de Programmer &#x200B;](#programmer) zonder de behoefte om voor elk van hen voor authentiek te verklaren.
...
Voor meer informatie, verwijs naar de [&#x200B; BasisTempPass &#x200B;](/help/premium-workflow/temporary-access/temp-pass-feature.md#basic-temp-pass) documentatie.
...
Voor meer informatie, verwijs naar de [&#x200B; BevorderingsTempPass &#x200B;](/help/premium-workflow/temporary-access/temp-pass-feature.md#promotional-temp-pass) documentatie.
...
Voor meer informatie, verwijs naar de [&#x200B; documentatie van de Gids van de Gebruiker van het Dashboard van 0&rbrace; TVE.](/help/authentication/user-guide-tve-dashboard/tve-dashboard-overview.md)
...
De tv-provider wordt geïdentificeerd door een unieke waarde die tijdens het instapproces tussen de tv-provider en Adobe is gedefinieerd.
...
Voor meer informatie, verwijs naar de [&#x200B; documentatie van Meta-gegevens van de Gebruiker 0&rbrace;.](/help/authentication/integration-guide-programmers/features-standard/entitlements/user-metadata.md)
