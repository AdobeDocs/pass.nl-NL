...
De authentificatiesessie kan op de [ toepassing van de 0} Programmer {ook wijzen om met het ](#programmer) toestemmings [ proces als volgende fase van de ](#authorization) recht [ stroom te werk te gaan voor het geval de gebruiker reeds voor authentiek verklaard wordt.](#entitlement)
...
Voor meer informatie, verwijs naar de [ documentatie van de Eigenschap van 0} Afbraak.](/help/premium-workflow/degraded-access/degradation-feature.md)

#### Apparaat-id {#device-id}

Apparaatidentiteitskaart is een uniek herkenningsteken gebonden aan het apparaat van de gebruiker en moet door de [ 1} toepassing van de Programmer {op alle fasen van de ](#programmer) betitelings [ stroom worden verstrekt.](#entitlement)
...
Voor meer informatie, verwijs naar de [ documentatie van de Gids van de Gebruiker van het Dashboard van 0} TVE.](/help/authentication/user-guide-tve-dashboard/tve-dashboard-overview.md)
...
Voor meer informatie, verwijs naar de [ documentatie van Meta-gegevens van de Gebruiker 0}.](/help/authentication/integration-guide-programmers/features-standard/entitlements/user-metadata.md)
