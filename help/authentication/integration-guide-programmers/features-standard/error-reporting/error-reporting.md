...
| N003 | Info | De gebruiker selecteert de optie Andere tv-provider in de Apple MVPD-kiezer. | *displayProviderDialog* callback zal worden geroepen en de toepassing kon aan regelmatige authentificatiestroom terugvallen. | Selecteer regelmatige MVPD en ga met het login scherm verder. | nvt | Ja | nvt |
| N004 | Info | De gebruiker selecteert een tv-provider die niet door de huidige aanvrager wordt ondersteund. | *displayProviderDialog* callback zal worden geroepen en de toepassing kon aan regelmatige authentificatiestroom terugvallen. | Selecteer regelmatige MVPD en ga met het login scherm verder. | nvt | Ja | nvt |
...
| N011 | Info | De gebruiker is geverifieerd met TempPass. | - Informeer de gebruiker. <br> <br> - U kunt desgewenst een lijst met normale MVPD&#39;s presenteren. | Meld u optioneel aan met uw normale MVPD. | Ja | Ja | Ja van 3.2 |
