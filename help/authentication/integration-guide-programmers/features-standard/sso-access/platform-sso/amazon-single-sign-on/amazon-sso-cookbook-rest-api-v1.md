...
Dit document doet dienst als uitbreiding aan het bestaande [ REST API V1 Overzicht ](/help/authentication/integration-guide-programmers/legacy/rest-api-v1/apis/rest-api-overview.md) dat een mening op hoog niveau verstrekt.
