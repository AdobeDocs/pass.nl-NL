...
In het huidige digitale landschap hebben gebruikers altijd, overal en altijd toegang tot internet en kunnen ze toegang aanvragen tot uw beveiligde inhoud. Misschien kijken ze naar een eenmalig evenement of zoeken ze de rechten om een hele televisieserie te streamen die je stuurt.
...
![&#x200B; die&rbrace; gebruikerstoestemming direct door programmeur wordt bepaald &#x200B;](/help/authentication/assets/user-ent-by-progr.png){align="center"}
...
![&#x200B; Gebruikersnaam die door de Authentificatie van Adobe Pass wordt gemedieerd &#x200B;](/help/authentication/assets/user-ent-mediatedby-authn.png){align="center"}
...
|                      | **Hoog** | Home-Based Authentication (HBA) | Voor meer details, verwijs naar [&#x200B; op huis-Gebaseerde Authentificatie &#x200B;](/help/premium-workflow/hba-access/home-based-authentication.md). |
