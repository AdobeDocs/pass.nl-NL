...
Afhankelijk van uw app **[!UICONTROL target SDK level]** of het gebruik van **android:requestLegacyExternalStorage** manifest attribuut Single Sign-On (SSO) die door Android versie 3.2.1 SDK van de Toegang wordt aangeboden (recentste) en de vorige versies zullen momenteel als volgt gedragen:
