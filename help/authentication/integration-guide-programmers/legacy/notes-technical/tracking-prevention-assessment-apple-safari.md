...
Om de individualisatieproblemen te verlichten en een gebruikersinteractie te hebben adviseren wij u om **[de Voldoende Pas van de Bevordering](/help/premium-workflow/temporary-access/temp-pass-feature.md#promotional-temp-pass)** op een interactieve manier te gebruiken, en minstens één extra informatie over de gebruiker (bijvoorbeeld, e-mailadres) te verstrekken.
